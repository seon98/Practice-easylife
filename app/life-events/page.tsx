...
export default async function LifeEventsPage(){const events=await getLifeEvents();return <main className="mx-auto min-h-screen max-w-7xl px-6 py-12"><p className="text-sm font-semibold text-blue-700">생활 내비게이션</p><h1 className="mt-3 text-4xl font-bold">무슨 일이 생겼나요?</h1><p className="mt-4 max-w-2xl leading-7 text-gray-600">기관 이름을 몰라도 괜찮습니다. 지금 상황을 고르면 해야 할 일, 준비 자료와 공식 신청처를 실행 순서로 안내합니다.</p><div className="mt-10"><LifeEventExplorer events={events}/></div></main>}
